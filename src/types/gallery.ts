...
export const ImageCollectionSchema = z.object({
	...
	hoverCoverUrl: z.string().nullable().optional(),
	topicId: z.number().nullable().optional(),
	topicNameCkb: z.string().nullable().optional(),
	topicNameKmr: z.string().nullable().optional(),
	publishmentDate: z.string().nullable(),
	contentLanguages: z.array(ContentLanguageSchema),
	ckbContent: ImageCollectionContentSchema.nullable(),
	kmrContent: ImageCollectionContentSchema.nullable(),
