...
const RAW_VIDEOS: Video[] = [
		...
		highlightClips: [
			{
				titleCkb: "ڕێگای کۆچ",
				titleKmr: "Rêya koçê",
				thumbnailUrl: "/writings/images/5.jpeg",
				url: SAMPLE_MP4,
			},
			{
	...
	makeVideo({
		...
		ckbContent: {
			title: "وتارەکانی مێژوو",
			description:
				"زنجیرەیەک کلیپ لە وتارە زانستییەکان دەربارەی سەرچاوەکانی مێژووی کورد.",
			location: "هەولێر",
			director: "د. ڕێبوار ئەحمەد",
			producer: "ئینستیتیوتی کەلەپووری کوردی",
		},
		kmrContent: {
			title: "Dersên Dîrokê",
			description:
				"Rêzeyek klîp ji dersên zanistî yên derbarê çavkaniyên dîroka kurdî.",
			location: "Hewlêr",
			director: "Dr. Rêbar Ehmed",
			producer: "Enstîtuya Kelepora Kurdî",
		},
		videoClipItems: [
			{
			...
			},
			{
				...
				url: SAMPLE_MP4,
				durationSeconds: 480,
				titleCkb: "نووسین و ئەرشیف",
				titleKmr: "Nivîs û arşîv",
			},
		],
		fileFormat: "mp4",
		durationSeconds: 1020,
		publishmentDate: "2026-03-05",
		resolution: "1920x1080",
		fileSizeMb: 520.0,
		tagsCkb: ["مێژوو", "وتار"],
		tagsKmr: ["Dîrok", "Ders"],
	...
	makeVideo({
		...
		videoType: "VIDEO_CLIP",
		topicId: 5,
		ckbCoverUrl: "/news/3.jpg",
		kmrCoverUrl: "/news/3.jpg",
		hoverCoverUrl: "/news/7.jpg",
		ckbContent: {
			title: "هەواڵی وێنەیی کوردستان",
			description:
				"کۆمەڵێک تۆماری هەواڵی وێنەیی ڕێستۆرکراو لە سەرانسەری کوردستان.",
			location: "سلێمانی",
			director: "ئەرشیفی شار",
			producer: "ئینستیتیوتی کەلەپووری کوردی",
		},
		kmrContent: {
			title: "Nûçeyên Wêneyî yên Kurdistanê",
			description:
				"Komele tomarên nûçeyên wêneyî yên restorekirî ji seranseriya Kurdistanê.",
			location: "Silêmanî",
			director: "Arşîva Bajêr",
			producer: "Enstîtuya Kelepora Kurdî",
		},
		videoClipItems: [
			{
				...
				url: SAMPLE_MP4,
				durationSeconds: 240,
				titleCkb: "بازاڕی سلێمانی",
				titleKmr: "Bazara Silêmanî",
			},
			{
				clipNumber: 2,
				url: SAMPLE_MP4,
				durationSeconds: 195,
				titleCkb: "کارگەی دەست",
				titleKmr: "Kargeha dest",
			},
			{
				clipNumber: 3,
				url: SAMPLE_MP4,
				durationSeconds: 210,
				titleCkb: "جەماوەری شار",
				titleKmr: "Gelê bajêr",
			},
		],
		fileFormat: "mp4",
		durationSeconds: 645,
		publishmentDate: "2026-02-20",
		resolution: "1440x1080",
		fileSizeMb: 380.0,
		tagsCkb: ["هەواڵ", "ئەرشیف"],
		tagsKmr: ["Nûçe", "Arşîv"],
		keywordsCkb: ["شار"],
		keywordsKmr: ["Bajar"],
	...
	makeVideo({
		...
		ckbCoverUrl: "/menu/4.jpg",
		kmrCoverUrl: "/menu/4.jpg",
		hoverCoverUrl: "/menu/8.jpg",
		ckbContent: {
			title: "بەڵگەنامەی دەستی کار",
			description:
				"زنجیرەیەک کلیپ لە بەڵگەنامەیەکی کورت دەربارەی پیشەسازی دەستی کوردی.",
			location: "کەرکوک",
			director: "هێمن ڕەشید",
			producer: "ئینستیتیوتی کەلەپووری کوردی",
		},
		kmrContent: {
			title: "Belgefîlmên Destkarî",
			description:
				"Rêzeyek klîp ji belgefîlmek kurt li ser prensa destkarî ya kurdî.",
			location: "Kerkûk",
			director: "Hêmin Reşîd",
			producer: "Enstîtuya Kelepora Kurdî",
		},
		videoClipItems: [
			{
				...
				url: SAMPLE_MP4,
				durationSeconds: 360,
				titleCkb: "بەرگی کوردی",
				titleKmr: "Cilên kurdî",
			},
			{
				clipNumber: 2,
				url: SAMPLE_MP4,
				durationSeconds: 420,
				titleCkb: "خشڵ و ئاڵنگاری",
				titleKmr: "Xêl û alengarî",
			},
		],
		fileFormat: "mp4",
		durationSeconds: 780,
		publishmentDate: "2026-02-05",
		resolution: "1920x1080",
		fileSizeMb: 445.0,
		tagsCkb: ["دەستکاری", "بەڵگەنامە"],
		tagsKmr: ["Destkarî", "Belgefîlm"],
		keywordsCkb: ["پیشە"],
		keywordsKmr: ["Pîşe"],
	...
	makeVideo({
		...
		videoType: "VIDEO_CLIP",
		topicId: 3,
		ckbCoverUrl: "/menu/2.jpg",
		kmrCoverUrl: "/menu/2.jpg",
		hoverCoverUrl: "/menu/9.jpg",
		ckbContent: {
			title: "گۆرانییە نەریتییەکان",
			description:
				"زنجیرەیەک کلیپ لە گۆرانی و ئاهەنگی نەریتی کورد لە ناوچە جیاوازەکان.",
			location: "سنە",
			director: "کاروان عەلی",
			producer: "ئینستیتیوتی کەلەپووری کوردی",
		},
		kmrContent: {
			title: "Stranên Kevneşopî",
			description:
				"Rêzeyek klîp ji stran û awazên kevneşopî yên kurdî ji herêmên cuda.",
			location: "Sine",
			director: "Karwan Elî",
			producer: "Enstîtuya Kelepora Kurdî",
		},
		videoClipItems: [
			{
				...
				url: SAMPLE_MP4,
				durationSeconds: 260,
				titleCkb: "گۆرانی شەوانە",
				titleKmr: "Strana şevê",
			},
			{
				clipNumber: 2,
				url: SAMPLE_MP4,
		...
		fileFormat: "mp4",
		durationSeconds: 570,
		publishmentDate: "2026-01-28",
		resolution: "1280x720",
		fileSizeMb: 290.0,
		tagsCkb: ["گۆرانی", "مۆسیقا"],
		tagsKmr: ["Stran", "Muzîk"],
		keywordsCkb: ["نەریت"],
		keywordsKmr: ["Kevneşop"],
