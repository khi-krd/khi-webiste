...
export const HOME_IMAGE_BENTO_TRAY_CLASS =
	// .home-band reads --site-band-bg (default: --color-foreground) so the
	// dashboard can recolor every dark home band without a redeploy.
	"home-band h-full min-h-0 w-full overflow-hidden p-2 sm:p-3 lg:p-4";
