...
/**
 * Injects the dashboard-picked typefaces. The CSS is generated by
 * buildSiteFontCss from fixed family names and encodeURIComponent'd,
 * host-allowlisted URLs — no admin-typed string reaches the stylesheet raw.
 */
...
export default async function LocaleLayout({ children, params }: Props) {
	...
	const siteFontCss = buildSiteFontCss(siteSettings);
	...
	return (
		...
		>
			...
			<body className="font-sans antialiased">
				...
				{siteFontCss ? <SiteFontStyle css={siteFontCss} /> : null}
