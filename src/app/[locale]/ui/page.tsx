			...
			<UiPlaygroundMain>
				...
				>
					<div className="flex max-w-md flex-col gap-8">
						<Sample label={t("divider.horizontal")}>
							<Divider />
						</Sample>
						<Sample label={t("divider.withLabel")}>
							<Divider>{t("divider.or")}</Divider>
						</Sample>
						<Sample label={t("divider.vertical")}>
							<div className="flex h-12 items-center gap-4">
								...
								<span className="text-small text-muted">C</span>
							</div>
						</Sample>
					</div>
				</Section>
