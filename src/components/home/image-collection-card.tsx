	...
	return (
		<Link
			...
			className={cn(
				...
				"transition-[box-shadow,z-index] duration-500",
				imageEase,
				"fine-hover:z-20 fine-hover:shadow-[0_8px_24px_-8px_color-mix(in_oklch,var(--color-foreground)_45%,transparent)]",
				className,
			)}
		...
		>
			<NextImage
				...
				className={cn(
					...
					imageEase,
					"group-fine:scale-[1.05] motion-reduce:transition-none motion-reduce:duration-0 motion-reduce:group-fine:scale-100",
				)}
			/>
			...
			<div
				className={cn(
					"pointer-events-none absolute inset-0 z-1 bg-linear-to-t from-foreground from-0% via-foreground/65 via-38% to-transparent to-70% opacity-0 transition-opacity duration-500",
					imageEase,
					"group-fine:opacity-100 group-focus-visible:opacity-100",
					"motion-reduce:opacity-100 motion-reduce:transition-none",
				)}
