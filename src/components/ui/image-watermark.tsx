...
export function ImageWatermark({
	...
	useEffect(() => {
		...
		const measure = () => {
			...
			// offsets below are applied inside the same transform (the booklet
			// reader scales its page 0.5×–2×). Normalising by the host's own scale
			// keeps the mark on the artwork at every zoom level.
			const scale =
