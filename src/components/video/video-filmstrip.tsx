...
function Frame({
	...
	return (
		...
		>
			...
			>
				<span className="inline-flex size-11 items-center justify-center rounded-pill bg-primary/60 text-primary-foreground ring-1 ring-primary-foreground/30 backdrop-blur-[2px] transition-[transform,background-color,opacity] duration-[350ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] opacity-75 scale-90 group-fine:scale-100 group-fine:bg-primary/85 group-fine:opacity-100 group-data-[previewing]:scale-90 group-data-[previewing]:opacity-0 motion-reduce:transition-none motion-reduce:group-fine:scale-90">
