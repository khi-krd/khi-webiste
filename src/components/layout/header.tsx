...
export async function Header() {
	...
	return (
		<HeaderShell>
			<Container className="header-scale dir-row-unmirrored relative flex h-16 max-w-none items-center justify-between gap-4 px-8 sm:h-20 sm:px-10 2xl:max-w-[var(--canvas)]">
