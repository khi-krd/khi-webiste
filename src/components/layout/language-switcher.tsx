		...
		<div ref={containerRef} className="relative">
			...
			>
				...
				<LanguageIcon
					className={cn(
						"size-4 shrink-0",
						overlay ? "text-primary-foreground/75" : "text-muted",
					)}
					strokeWidth={1.75}
					aria-hidden="true"
				/>
			...
			<AnimatePresence>
				{open && (
					<motion.ul
						...
						className={cn(
							"absolute end-0 top-[calc(100%+0.375rem)] z-50 min-w-[11.5rem] overflow-hidden rounded-md border py-1 shadow-[0_8px_24px_color-mix(in_oklch,var(--color-foreground)_12%,transparent),0_2px_6px_color-mix(in_oklch,var(--color-foreground)_6%,transparent)]",
							overlay
