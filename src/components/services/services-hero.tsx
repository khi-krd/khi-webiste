...
export function ServicesHero({
	...
	return (
		...
		>
			...
			<ServicesHeroMotion className="relative z-10 flex min-h-svh flex-col justify-end px-6 pb-14 sm:px-10 sm:pb-16 lg:px-14 lg:pb-20 2xl:px-[max(3.5rem,calc((100vw-96rem)/2+2rem))] 2xl:pb-24">
				<div className="max-w-4xl text-start text-white">
					...
					<ServicesHeroBlock>
						<h2
							...
							className="hero-slide-title mt-3 2xl:text-[5.5rem]"
						>
							{title}
						</h2>
					</ServicesHeroBlock>
