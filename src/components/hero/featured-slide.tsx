...
export function FeaturedSlide({
	...
	return (
		...
		>
			...
			<div className="absolute inset-x-0 bottom-0 z-10 px-6 pb-14 sm:px-10 sm:pb-16 lg:px-14 lg:pb-20 2xl:px-[max(3.5rem,calc((100vw-var(--canvas))/2+2rem))] 2xl:pb-24">
